...
dataset = pd.read_csv('florida.csv')
...
plt.title('R&D vs Profit florida (Linear Regression')
plt.xlabel('R&D')
plt.ylabel('Profit')
plt.show()
...
plt.title('R&D vs Profit florida (Polynomial Regression)')
plt.xlabel('R&D')
plt.ylabel('Profit')
plt.show()
...
plt.title('R&D vs Profit florida(Decision Tree Regression)')
plt.xlabel('R&D')
plt.ylabel('Profit')
plt.show()
